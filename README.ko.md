...
| [deep-review](https://github.com/Sungmin-Cho/deep-review) | 2.8.1 | Independent Evaluator for AI coding agents |
...
| [deep-model-router](https://github.com/Sungmin-Cho/deep-model-router) | 1.5.1 | Deterministic model/effort/review router |
