...
| [deep-review](https://github.com/Sungmin-Cho/deep-review) | 2.10.0 | Independent Evaluator for AI coding agents |
...
| [deep-loop](https://github.com/Sungmin-Cho/deep-loop) | 1.23.0 | Loop Engineering control plane over the deep-suite |
| [deep-model-router](https://github.com/Sungmin-Cho/deep-model-router) | 1.14.0 | Deterministic model/effort/review router for Claude Code, Codex, and Grok |
